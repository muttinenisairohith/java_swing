...
GUI6(String a){
    ...
    b.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e)
             ...
             if((s1.matches("-?\\d+(\\.\\d+)?")) || (s2.matches("-?\\d+(\\.\\d+)?")) || (!s3.matches("-?\\d+(\\.\\d+)?")) || (!s4.matches("-?\\d+(\\.\\d+)?")) || (!s5.matches("-?\\d+(\\.\\d+)?")) || s1== "" || Integer.parseInt(s5) > 100 || Integer.parseInt(s5) < 0 || Integer.parseInt(s3) > 100 || Integer.parseInt(s3) < 0 || s2 == ""){
