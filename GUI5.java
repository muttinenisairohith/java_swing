...
GUI5(String a){
    ...
    b.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e)
             ...
             if((s1.matches("-?\\d+(\\.\\d+)?")) || (s2.matches("-?\\d+(\\.\\d+)?")) || (s5.matches("-?\\d+(\\.\\d+)?")) || (!s3.matches("-?\\d+(\\.\\d+)?")) || (!s4.matches("-?\\d+(\\.\\d+)?")) || (!s6.matches("-?\\d+(\\.\\d+)?")) || (!s7.matches("-?\\d+(\\.\\d+)?")) || (!s8.matches("-?\\d+(\\.\\d+)?"))  || s1== "" || Integer.parseInt(s8) > 100 || Integer.parseInt(s8) < 0 || Integer.parseInt(s4) > 100 || Integer.parseInt(s4) < 0 || Integer.parseInt(s3) > 100 || Integer.parseInt(s3) < 0|| s5 == "" || s2 == ""){
            	 JOptionPane.showMessageDialog(f1,"Invalid info");
             }
             else {
